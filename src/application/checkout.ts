import{quotePrice}from"../domain/pricing.js";import{type OrderState}from"../domain/order.js";import{reserveStock,type StockItem}from"./inventory.js";
...
export function buildCheckout(i:CheckoutInput,stock:StockItem[]):CheckoutResult{
 ...
 return{orderId:i.orderId,total,marginRate:marginNumerator/total,state:"pending_payment",reservations}
}
